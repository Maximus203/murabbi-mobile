...
void main() {
  group('AuthFailure', () {
    test('invalidCredentials carries an optional message and equality holds',
        () {
    ...
    test('emailAlreadyInUse / weakPassword / network / unknown are distinct',
        () {
    ...
    test('is an Exception (can be thrown/caught)', () {
      expect(() => throw const AuthFailure.invalidCredentials(),
          throwsA(isA<AuthFailure>()));
      expect(() => throw const AuthFailure.network(),
