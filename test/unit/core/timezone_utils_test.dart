...
void main() {
  ...
  group('TZHelper.isSameDay', () {
    ...
    test('retourne false quand les DateTime sont sur deux jours différents', () {
    ...
    test(
      ...
      () {
        ...
        expect(TZHelper.isSameDay(loggedUtc, scheduledStartUtc, ianaZone), isTrue);
      },
    );
    ...
    test(
      'utc_minus_5_log_at_22h_counts_as_correct_day — '
      ...
      () {
        ...
        final scheduledAt10hLocal = DateTime.utc(2025, 5, 23, 15, 0); // 10h Bogota J
        // Même jour local Bogota → true
        expect(TZHelper.isSameDay(logAt22hLocal, scheduledAt10hLocal, bogota), isTrue);
    ...
    test(
      'utc_plus_3_log_at_23h_counts_as_correct_day — '
