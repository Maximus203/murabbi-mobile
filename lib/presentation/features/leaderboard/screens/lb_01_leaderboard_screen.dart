...
/// initiales dérivées de l'userId (défaut défensif, ne devrait pas arriver
/// en production depuis que weekly_leaderboard expose pseudo).
...
class _LeaderboardEmpty extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final daysUntilSunday =
        now.weekday == DateTime.sunday ? 0 : 7 - now.weekday;
